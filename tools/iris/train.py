    ...
    bundle = {
        ...
        "nets": {
            ...
            "iris_rnd2": {
                ...
                "description": "two random gaussian directions in parameter space, each as long as θ*; reseed / rescale them in the Controls pane",
                "directions": [random_direction(0), random_direction(1)],
            },
            "iris_rnd3": {
                "type": "displace", "net": "iris_star", "name": "θ* + t₀ d₀ + t₁ d₁ + t₂ d₂",
                "description": "three random gaussian directions in parameter space, each as long as θ*; d₀ and d₁ are the same draws as in the 2D space",
                "directions": [random_direction(0), random_direction(1), random_direction(2)],
            },
        },
        "fields": {
